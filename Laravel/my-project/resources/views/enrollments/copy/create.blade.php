<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg p-8">
        <h2 class="text-2xl font-semibold text-blue-800 dark:text-white mb-6 text-center">Enroll</h2>
        ...
        <form method="POST" action="{{ route('enrollments.store') }}" class="space-y-6">
            ...
            <div>
                <select id="category" name="category" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition">
