                        ...
                        <table class="w-full border-collapse border border-gray-300 dark:border-gray-600">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-right">{{ number_format($enrollment->fees->tuition_fee, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2">Lab Fee</td>
                                    <td class="border px-4 py-2 text-right">{{ number_format($enrollment->fees->lab_fee, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2">Miscellaneous Fee</td>
                                    <td class="border px-4 py-2 text-right">{{ number_format($enrollment->fees->miscellaneous_fee, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2">Other Fee</td>
                                    <td class="border px-4 py-2 text-right">{{ number_format($enrollment->fees->other_fee, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2">Initial Payment</td>
                                    <td class="border px-4 py-2 text-right">-{{ number_format($enrollment->fees->initial_payment, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="border px-4 py-2">Discount</td>
                                    <td class="border px-4 py-2 text-right">-{{ number_format($enrollment->fees->discount, 2) }}</td>
                                </tr>
                            </tbody>
